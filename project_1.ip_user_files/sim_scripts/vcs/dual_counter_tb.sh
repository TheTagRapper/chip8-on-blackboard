...
#
# Script generated by Vivado on Fri Jul 31 15:05:09 BST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dual_counter_tb.sh
...
#
# Usage        : dual_counter_tb.sh
#                dual_counter_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dual_counter_tb.sh [-rerun]
#                dual_counter_tb.sh [-reset_run]
#                dual_counter_tb.sh [-clean]
#                dual_counter_tb.sh [-reset_log]
#                dual_counter_tb.sh [-help]
#
...
#                script (type 'dual_counter_tb.sh -help' for more information).
#
...
# script info
echo -e "dual_counter_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dual_counter_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../media/pyra/88d368f5-2c7d-43f4-90cd-458b64c9c5111/Vivado/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../media/pyra/88d368f5-2c7d-43f4-90cd-458b64c9c5111/Vivado/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../../../../../media/pyra/88d368f5-2c7d-43f4-90cd-458b64c9c5111/Vivado/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/clock_div.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/dual_counter.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/bin_counter.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/clk_div.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/matrix_decoder.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/matrix_to_sevenseg.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/sevenseg_decoder.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/testingPMODC.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/vga_controller.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sources_1/new/display_controller.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sim_1/new/matrix_decoder_tb.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sim_1/new/matrix_to_sevenseg_tb.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sim_1/new/bin_counter_tb.sv" \
  "../../../../../Personal\\ Projects/CHIP8-on-Blackboard/project_1.srcs/sim_1/new/dual_counter_tb.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dual_counter_tb xil_defaultlib.glbl -o dual_counter_tb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dual_counter_tb_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/pyra/Documents/Personal"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dual_counter_tb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dual_counter_tb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dual_counter_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dual_counter_tb.sh [-help]\n\
Usage: dual_counter_tb.sh [-step]\n\
Usage: dual_counter_tb.sh [-lib_map_path]\n\
Usage: dual_counter_tb.sh [-rerun]\n\
Usage: dual_counter_tb.sh [-reset_run]\n\
Usage: dual_counter_tb.sh [-clean]\n\
Usage: dual_counter_tb.sh [-reset_log]\n\
Usage: dual_counter_tb.sh [-keep_index]\n\
Usage: dual_counter_tb.sh [-noclean_files]\n\n\
